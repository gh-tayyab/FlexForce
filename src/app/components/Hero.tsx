...
function Hero() {
    return (
        <div className="bg min-h-screen flex flex-col md:flex-row justify-center items-center bg-slate-900">
            ...
            <Image
                ...
                objectPosition='fill'
            />
                    <h1 data-aos="fade-up" className=' text-4xl sm:text-4xl md:text-6xl w-full md:w-2/4 font-bold leading-tight'>You Only Fail, When You Stop Trying</h1>
